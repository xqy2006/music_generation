...
var config = {
   ...
   data:{url:'https://github.com/login/oauth/access_token?client_id=Iv1.3834dcfa06a1a6ae&client_secret=335e97d37b134dcc3e6a824bd902ab1884e22c03&code='+this.id},
   headers: { 
...
.then((response)=>{
   ...
   fetch(
		...
		{
      headers: {Authorization: "token "+response.data.access_token,"Content-Type":'application/json'  },
			method: "POST",
      mode: 'cors',
			body: JSON.stringify({
